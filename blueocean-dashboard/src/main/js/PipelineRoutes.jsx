...
import { Pipelines, MultiBranch, Activity, PullRequests, PipelinePage, PipelineTrends, RunDetails, RunDetailsPipeline } from './components';
...
function getRunDetailsAction({ params }, callback) {
    ...
    switch (params.action) {
        case 'changes':
            analytics.trackPipelineRunChangesVisited();
            break;
        case 'tests':
            analytics.trackPipelineRunTestsVisited();
            break;
        case 'artifacts':
            analytics.trackPipelineRunArtifactsVisited();
            break;
    }
...
export default (
    <Route component={Dashboard} onEnter={onTopLevelRouteEnter} onChange={onRouteChange}>
        ...
        <Route path="organizations/:organization" component={PipelinePage}>
            ...
            <Route path=":pipeline/sites" component={Sites} onEnter={analytics.trackPipelineSitesVisited} />
